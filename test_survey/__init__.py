...
class Player(BasePlayer):
    ...
    talking = models.IntegerField(
            ...
            choices=[[1, 'Extremely inappropriate'],
                [2, 'w'],
                [3, 'w'],
                [4, 'w'],
                [5, 'w'],
...
class Julian(Page):
    form_model = 'player'
    form_fields = ['talking', 'avoiding', 'nothing', 'angry', 'violating']
    ...
    def before_next_page(player, timeout_happened):
        ...
        player.violating = player.violating
...
page_sequence = [EndGameControl, EndGameEco, Decision_info_eco, Decision_info_control, Julian, EmotionsPast, EmotionsDuring, Questionnaire, Demographics, Thankyou]
